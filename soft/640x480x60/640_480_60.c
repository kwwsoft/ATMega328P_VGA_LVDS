...
//   Timer 1 - vertical sync pulses
 ...
 //
  ...
  TCCR2B |= (1<<WGM22);
  OCR2A = 63;   //63*0.5 =  31.5 mks
  OCR2B = 7;    //7*0.5 = 3.5 mks
  TIFR2 = 0;
  ...
  TCCR1A |= (0<<COM1A1)|(0<<COM1A0)|(1<<COM1B1)|(1<<COM1B0);
  //set top value to ICR1
  ICR1H = 4;     // (4*256 + 19)*16 = 16688
  ICR1L = 19;    //
  TCCR1A |= (0<<WGM10)|(1<<WGM11);
  TCCR1B |= (1<<WGM12)|(1<<WGM13);
  OCR1BH=0;
  OCR1BL=3;   //4*16 = 64 mks
  //clk/256     t= 16 mks
...
_start:;
  Delay_ms(300);
  L3310_ClearScreen();
  L3310_WriteStringAtCenter(0, s_vga_640_480_60, 0);
...
next_2:;
     ...
     L3310_ClearScreen();
     L3310_WriteStringAtCenter(0, s_vga_640_480_60, 1);
